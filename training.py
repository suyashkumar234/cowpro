...
def cfg():
    ...
    # Add these to your config function in config_ssl_upload.py
    run_param_tuning = True  # Whether to run parameter tuning experiments
    use_best_params = True  # Whether to use the best parameters from tuning

    # Network
    modelname = 'dlfcn_res101' # resnet 101 backbone from torchvision fcn-deeplab
    clsname = 'grid_proto' # 
    resume = False
    reload_model_path = './runs/mySSL__CHAOST2_Superpix_sets_0_1shot/48/snapshots/100000.pth' # path for reloading a trained model (overrides ms-coco initialization)
